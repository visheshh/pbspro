...
#define STMT_SELECT_JOB_LOCKED "select_job_locked"
...
#define STMT_SELECT_RESV_LOCKED "select_resv_locked"
...
#define STMT_SELECT_QUE_LOCKED "select_que_locked"
...
#define STMT_SELECT_NODE_LOCKED "select_node_locked"
...
#define STMT_SELECT_SCHED_LOCKED "select_sched_locked"
...
int pg_db_load_svr(pbs_db_conn_t *conn, pbs_db_obj_info_t *obj, int lock);
...
int pg_db_load_mominfo_tm(pbs_db_conn_t *conn, pbs_db_obj_info_t *obj, int lock);
...
int pg_db_load_sched(pbs_db_conn_t *conn, pbs_db_obj_info_t *obj, int lock);
