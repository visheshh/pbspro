 ...
 * later version.
 *
 * PBS Pro is distributed in the hope that it will be useful, but WITHOU8T ANY
...
req_shutdown(struct batch_request *preq)
{
	...
	if (shutdown_who & SHUT_WHO_SCHED)
		(void)contact_sched(SCH_QUIT, NULL, pbs_scheduler_addr, pbs_scheduler_port);	/* tell scheduler to quit */
